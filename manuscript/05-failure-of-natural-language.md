...
- N-5: If a delivery attempt fails for any reason other than a suppressed preference, the system **MUST** retry according to the retry policy in §3; a delivery failure **MUST NOT** cause the settled transaction to be reversed.
